  ...
  return (
    <div className="relative w-full overflow-hidden bg-neutral-950">
      ...
      <div className="container text-white mx-auto h-full w-full px-4 md:px-10 py-10 md:py-20">
        <h1 className="text-lg relative z-20 max-w-fit">Our Services</h1>
        <h1
          className={cn(
            "md:text-5xl my-6 font-semibold text-xl max-w-fit text-blue-500 relative z-20"
          )}
        >
          Find out more about <br /> our IT support
        </h1>
        <p className="text-lg max-w-7xl relative z-20">
        ...
        <div className="flex flex-col gap-6 mt-8">
          ...
          <Link
            ...
            className="group block hover:-translate-y-2 duration-500 w-full relative z-20"
          >
